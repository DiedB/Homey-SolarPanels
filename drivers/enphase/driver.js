...
var base_url = "https://api.enphaseenergy.com/api/v2/systems/";
var devices = {};
...
module.exports.pair = function (socket) {
    socket.on("validate", function (data, callback) {
        var url = base_url + data.sid + "/summary?key=" + data.key + "&user_id=" + data.uid;
...
function checkProduction(device_data) {
    ...
    var url = base_url + device_data.id + "/summary?key=" + device_data.key + "&user_id=" + device_data.uid;
